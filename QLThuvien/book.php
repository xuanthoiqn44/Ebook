                ...
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        ...
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								<li role="presentation" class="active"><a href="index.php">All</a></li>
								<?php $result= $db->db_query("select * from category order by category_id DESC ") or die (mysql_error());
								while ($row=$db->db_fetch_array($result) ){
								?>
								<li role="presentation" ><a href="view_category.php?category=<?php echo $row['classname']?>"><?php echo $row['classname']?></a></li>
							<?php }?>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= $db->db_query("select * from book order by book_id DESC ") or die (mysql_error());
							while ($row=$db->db_fetch_array($result) ){
							$id=$row['book_id'];
