...
<?php	// 	include ('add_modal_example.php'); ?>
							...
							while ($row11= mysql_fetch_array ($allowed_book_query) ){
							...
							?>
									...
									<div class="modal-dialog">
										...
										<div class="modal-body">
												<?php
												$query1=mysql_query("select * from allowed_book where allowed_book_id='$id'")or die(mysql_error());
												$row22=mysql_fetch_array($query1);
												?>
												...
												<?php
													...
													{
														mysql_query (" UPDATE allowed_book SET qntty_books='$qntty_books' ") or die (mysql_error());
													}
													{
