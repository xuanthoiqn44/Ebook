				...
				-->
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysql_query("select *,(SELECT COUNT(*) FROM user_log WHERE user_id = tbl_user.user_id) AS levelCount from user_log 
							LEFT JOIN user AS tbl_user ON user_log.user_id = tbl_user.user_id 
							group by user_log.user_name ORDER BY user_log.user_log_id ASC ") or die (mysql_error());
							
							$q = mysql_query("select COUNT(distinct firstname) as total from user");
