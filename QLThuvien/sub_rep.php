                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysql_query("select * from book where status = 'Replacement' ") or die (mysql_error());
							while ($row= mysql_fetch_array ($result) ){
							$id=$row['book_id'];
							$category_id=$row['category_id'];
							
							$cat_query = mysql_query("select * from category where category_id = '$category_id'")or die(mysql_error());
