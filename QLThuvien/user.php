	...
	<?php if($_SESSION['user_type'] == "Admin") {?>
        <div class="page-title">
            <div class="title_left">
                <h3>
					<small>Trang Chủ /</small> Thành Viên
                </h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
							...
							<button class="btn btn-danger pull-right"><i class="fa fa-print"></i> In Danh Sách Thành Viên</button>
							</a>
							...
							<br />
                    <div class="x_title">
                        <h2><i class="fa fa-users"></i> Thông Tin Thành Viên</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
							<a href="add_user.php" style="background:none;">
							<button class="btn btn-primary btn-outline"><i class="fa fa-plus"></i> Thêm Thành Viên</button>
							</a>
							</li>
                            <li>
							<a href="import_members.php" style="background:none;">
							<button class="btn btn-success btn-outline"><i class="fa fa-upload"></i> Thêm Từ file</button>
							</a>
							</li>
                        <!---    <li>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$db = new Database();
							$result= $db->db_query("select * from user order by user_id DESC") or die (mysql_error());
