...
<?php //	include ('add_modal_example_3.php'); ?>
                                <div class="x_content">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
							<?php
							$penalty_query= mysql_query("select * from allowed_days order by allowed_days_id DESC ") or die (mysql_error());
							while ($row33= mysql_fetch_array ($penalty_query) ){
							...
							?>
									...
									<div class="modal-dialog">
										...
										<div class="modal-body">
												<?php
												$query2=mysql_query("select * from allowed_days where allowed_days_id='$allowed_days_id'")or die(mysql_error());
												$row44=mysql_fetch_array($query2);
												?>
												...
												<?php
													...
													{
														mysql_query (" UPDATE allowed_days SET no_of_days='$no_of_days1' ") or die (mysql_error());
													}
													{
