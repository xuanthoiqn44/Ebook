        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					...
					$result=$db->db_query("select * from admin WHERE username='$username' ") or die (mySQL_error());
					...
					{		
						$db->db_query("insert into admin (firstname, middlename, lastname, username, password, confirm_password, admin_image, admin_type, admin_added)
						values ('$firstname', '$middlename', '$lastname', '$username', '$passmd5', '$confirmmd5', '$profile', 'Admin', NOW())")or die(mysql_error());
