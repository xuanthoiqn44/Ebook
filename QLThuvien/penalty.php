...
<?php // 	include ('add_modal_example_2.php'); ?>
                                ...
                                <div class="x_content">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
							<?php
							$penalty_query= mysql_query("select * from penalty order by penalty_id DESC ") or die (mysql_error());
							...
							?>
									...
									<div class="modal-dialog">
										...
										<div class="modal-body">
												<?php
												$query2=mysql_query("select * from penalty where penalty_id='$penalty_id'")or die(mysql_error());
												...
												<?php
													...
													{
														mysql_query (" UPDATE penalty SET penalty_amount='$penalty_amount1' ") or die (mysql_error());
													}
													{
