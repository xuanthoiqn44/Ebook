...
include ('include/dbcon.php');
							...
							$count_penalty = mysql_query("SELECT sum(book_penalty) FROM return_book 
							where return_book.date_returned BETWEEN '".$_SESSION['datefrom']." 00:00:01' and '".$_SESSION['dateto']." 23:59:59'  ")or die(mysql_error());
